...
def test_sale_woo_notice(browser):
    sale = Sale(browser)
    sale.load()
    sale.create_sale_notice('woo', 'n', 'n', 'R')  # Source - Advanced Design - Queue Management - Position
...
def test_sale_edd_notice(browser):
    sale = Sale(browser)
    sale.load()
    sale.create_sale_notice('edd', 'n', 'n', 'L')  # Source - Advanced Design - Queue Management - Position
...
def test_review_org_notice(browser):
    ...
    review.load()
    review.create_review_notice('org-review', 'n', 'n', 'R')  # Source - Advanced Design - Queue Management - Position
...
def test_review_woo_notice(browser):
    review = Review(browser)
    review.load()
    review.create_review_notice('woo-review', 'n', 'n', 'L')  # Source - Advanced Design - Queue Management - Position
...
def test_d_stats_notice(browser):
    ...
    d_stats.load()
    d_stats.create_d_stats_notice('n', 'n', 'R')  # Advanced Design - Queue Management - Position
...
def test_e_learning_notice(browser):
    ...
    e_learning.load()
    e_learning.create_e_learning_notice('tutor', 'n', 'n',
...
def test_donation_notice(browser):
    ...
    donation.load()
    donation.create_donation_notice('n', 'n', 'R')  # Advanced Design - Queue Management - Position
...
def test_comment_notice(browser):
    ...
    comment.load()
    comment.create_comment_notice('n', 'n', 'L')  # Advanced Design - Queue Management - Position
...
def test_contact_form_notice(browser):
    ...
    contact_form.load()
    contact_form.create_review_notice('cf7', 'n', 'n', 'L')  # Source - Advanced Design - Queue Management - Position
...
def test_page_analytics_notice(browser):
    ...
    page_analytics.load()
    page_analytics.create_page_analytics_notice('n', 'n', 'L')  # Advanced Design - Queue Management - Position
...
def test_custom_notice(browser):
    ...
    custom.load()
    custom.create_custom_notice('n', 'n', 'R')  # Advanced Design - Queue Management - Position
